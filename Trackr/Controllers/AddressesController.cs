...
{
    /// <summary>
    /// Web API Controller for Addresses entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class AddressesController : OpenAccessBaseApiController<TrackrModels.Address, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public AddressesController(IOpenAccessBaseRepository<TrackrModels.Address , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Address Get(Int32 id)
        {
            TrackrModels.Address entity = repository.GetBy(t => t.AddressID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Address entity)
        {
                        if (entity == null ||
                id != entity.AddressID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Address entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Address>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.AddressID });
