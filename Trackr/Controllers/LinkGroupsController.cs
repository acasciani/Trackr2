...
{
    /// <summary>
    /// Web API Controller for LinkGroups entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class LinkGroupsController : OpenAccessBaseApiController<TrackrModels.LinkGroup, TrackrModels.UserManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public LinkGroupsController()
        {
            this.repository = new LinkGroupRepository();
        }
        ...
        public LinkGroupsController(IOpenAccessBaseRepository<TrackrModels.LinkGroup , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.LinkGroup Get(Int32 id)
        {
            TrackrModels.LinkGroup entity = repository.GetBy(t => t.LinkGroupID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.LinkGroup entity)
        {
                        if (entity == null ||
                id != entity.LinkGroupID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.LinkGroup entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.LinkGroup>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.LinkGroupID });
