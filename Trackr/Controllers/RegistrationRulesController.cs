...
{
    /// <summary>
    /// Web API Controller for RegistrationRules entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class RegistrationRulesController : OpenAccessBaseApiController<TrackrModels.RegistrationRule, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        {
            this.repository = new RegistrationRuleRepository();
        }
        ...
        public RegistrationRulesController(IOpenAccessBaseRepository<TrackrModels.RegistrationRule , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.RegistrationRule Get(Int32 id)
        {
            TrackrModels.RegistrationRule entity = repository.GetBy(t => t.RegistrationRuleID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.RegistrationRule entity)
        {
                        if (entity == null ||
                id != entity.RegistrationRuleID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.RegistrationRule entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.RegistrationRule>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.RegistrationRuleID });
