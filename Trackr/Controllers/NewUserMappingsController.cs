...
{
    /// <summary>
    /// Web API Controller for NewUserMappings entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class NewUserMappingsController : OpenAccessBaseApiController<TrackrModels.NewUserMapping, TrackrModels.UserManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public NewUserMappingsController()
        {
            this.repository = new NewUserMappingRepository();
        }
        ...
        public NewUserMappingsController(IOpenAccessBaseRepository<TrackrModels.NewUserMapping , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.NewUserMapping Get(Int32 id)
        {
            TrackrModels.NewUserMapping entity = repository.GetBy(t => t.NewUserMappingID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.NewUserMapping entity)
        {
                        if (entity == null ||
                id != entity.NewUserMappingID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.NewUserMapping entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.NewUserMapping>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.NewUserMappingID });
