...
{
    /// <summary>
    /// Web API Controller for Glyphicons entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class GlyphiconsController : OpenAccessBaseApiController<TrackrModels.Glyphicon, TrackrModels.UserManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public GlyphiconsController()
        {
            this.repository = new GlyphiconRepository();
        }
        ...
        public GlyphiconsController(IOpenAccessBaseRepository<TrackrModels.Glyphicon , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Glyphicon Get(Int32 id)
        {
            TrackrModels.Glyphicon entity = repository.GetBy(t => t.GlyphiconID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Glyphicon entity)
        {
                        if (entity == null ||
                id != entity.GlyphiconID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Glyphicon entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Glyphicon>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.GlyphiconID });
