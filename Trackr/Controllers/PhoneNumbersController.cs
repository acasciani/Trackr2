...
{
    /// <summary>
    /// Web API Controller for PhoneNumbers entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class PhoneNumbersController : OpenAccessBaseApiController<TrackrModels.PhoneNumber, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        {
            this.repository = new PhoneNumberRepository();
        }
        ...
        public PhoneNumbersController(IOpenAccessBaseRepository<TrackrModels.PhoneNumber , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.PhoneNumber Get(Int32 id)
        {
            TrackrModels.PhoneNumber entity = repository.GetBy(t => t.PhoneNumberID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.PhoneNumber entity)
        {
                        if (entity == null ||
                id != entity.PhoneNumberID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.PhoneNumber entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.PhoneNumber>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.PhoneNumberID });
