...
{
    /// <summary>
    /// Web API Controller for Messages entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class MessagesController : OpenAccessBaseApiController<TrackrModels.Message, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public MessagesController(IOpenAccessBaseRepository<TrackrModels.Message , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Message Get(Int64 id)
        {
            TrackrModels.Message entity = repository.GetBy(t => t.MessageID == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, TrackrModels.Message entity)
        {
                        if (entity == null ||
                id != entity.MessageID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Message entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Message>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.MessageID });
