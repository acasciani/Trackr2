...
{
    /// <summary>
    /// Web API Controller for TeamSchedules entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class TeamSchedulesController : OpenAccessBaseApiController<TrackrModels.TeamSchedule, TrackrModels.ClubManagement>
    {
        ...
        /// </summary>
        public TeamSchedulesController()
        {
            this.repository = new TeamScheduleRepository();
        }
        ...
        public TeamSchedulesController(IOpenAccessBaseRepository<TrackrModels.TeamSchedule , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.TeamSchedule Get(Int32 id)
        {
            TrackrModels.TeamSchedule entity = repository.GetBy(t => t.TeamScheduleID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.TeamSchedule entity)
        {
                        if (entity == null ||
                id != entity.TeamScheduleID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.TeamSchedule entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.TeamSchedule>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.TeamScheduleID });
