...
{
    /// <summary>
    /// Web API Controller for People entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class PeopleController : OpenAccessBaseApiController<TrackrModels.Person, TrackrModels.ClubManagement>
    {
        ...
        public PeopleController(IOpenAccessBaseRepository<TrackrModels.Person , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Person Get(Int32 id)
        {
            TrackrModels.Person entity = repository.GetBy(t => t.PersonID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Person entity)
        {
                        if (entity == null ||
                id != entity.PersonID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Person entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Person>(httpStatusCode, entityToEmbed);
