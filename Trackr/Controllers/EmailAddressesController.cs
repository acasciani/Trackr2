...
{
    /// <summary>
    /// Web API Controller for EmailAddresses entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class EmailAddressesController : OpenAccessBaseApiController<TrackrModels.EmailAddress, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        {
            this.repository = new EmailAddressRepository();
        }
        ...
        public EmailAddressesController(IOpenAccessBaseRepository<TrackrModels.EmailAddress , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.EmailAddress Get(Int32 id)
        {
            TrackrModels.EmailAddress entity = repository.GetBy(t => t.EmailAddressID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.EmailAddress entity)
        {
                        if (entity == null ||
                id != entity.EmailAddressID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.EmailAddress entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.EmailAddress>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.EmailAddressID });
