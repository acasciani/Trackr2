...
{
    /// <summary>
    /// Web API Controller for Links entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class LinksController : OpenAccessBaseApiController<TrackrModels.Link, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        public LinksController(IOpenAccessBaseRepository<TrackrModels.Link , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.Link Get(Int32 id)
        {
            TrackrModels.Link entity = repository.GetBy(t => t.LinkID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Link entity)
        {
                        if (entity == null ||
                id != entity.LinkID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Link entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Link>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.LinkID });
