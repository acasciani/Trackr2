...
{
    /// <summary>
    /// Web API Controller for MessageRecipients entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class MessageRecipientsController : OpenAccessBaseApiController<TrackrModels.MessageRecipient, TrackrModels.UserManagement>
    {
        /// <summary>
        ...
        {
            this.repository = new MessageRecipientRepository();
        }
        ...
        public MessageRecipientsController(IOpenAccessBaseRepository<TrackrModels.MessageRecipient , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.MessageRecipient Get(Int64 id)
        {
            TrackrModels.MessageRecipient entity = repository.GetBy(t => t.RecipientID == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, TrackrModels.MessageRecipient entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.MessageRecipient entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.MessageRecipient>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.RecipientID });
