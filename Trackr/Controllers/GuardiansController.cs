...
{
    /// <summary>
    /// Web API Controller for Guardians entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class GuardiansController : OpenAccessBaseApiController<TrackrModels.Guardian, TrackrModels.ClubManagement>
    {
        /// <summary>
        ...
        public GuardiansController(IOpenAccessBaseRepository<TrackrModels.Guardian , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Guardian Get(Int32 id)
        {
            TrackrModels.Guardian entity = repository.GetBy(t => t.GuardianID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Guardian entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Guardian entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Guardian>(httpStatusCode, entityToEmbed);
