...
{
    /// <summary>
    /// Web API Controller for LinkPermissions entity defined in TrackrModels.UserManagement data model
    /// </summary>
    public partial class LinkPermissionsController : OpenAccessBaseApiController<TrackrModels.LinkPermission, TrackrModels.UserManagement>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public LinkPermissionsController()
        {
            this.repository = new LinkPermissionRepository();
        }
        ...
        public LinkPermissionsController(IOpenAccessBaseRepository<TrackrModels.LinkPermission , TrackrModels.UserManagement> repository)
        {
        ...
        public virtual TrackrModels.LinkPermission Get(Int32 id)
        {
            TrackrModels.LinkPermission entity = repository.GetBy(t => t.LinkPermissionID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.LinkPermission entity)
        {
                        if (entity == null ||
                id != entity.LinkPermissionID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.LinkPermission entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.LinkPermission>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.LinkPermissionID });
