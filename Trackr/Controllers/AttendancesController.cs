...
{
    /// <summary>
    /// Web API Controller for Attendances entity defined in TrackrModels.ClubManagement data model
    /// </summary>
    public partial class AttendancesController : OpenAccessBaseApiController<TrackrModels.Attendance, TrackrModels.ClubManagement>
    {
        ...
        public AttendancesController(IOpenAccessBaseRepository<TrackrModels.Attendance , TrackrModels.ClubManagement> repository)
        {
        ...
        public virtual TrackrModels.Attendance Get(Int32 id)
        {
            TrackrModels.Attendance entity = repository.GetBy(t => t.AttendanceID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, TrackrModels.Attendance entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, TrackrModels.Attendance entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<TrackrModels.Attendance>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.AttendanceID });
